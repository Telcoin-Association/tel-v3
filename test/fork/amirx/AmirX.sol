...
// Fork-test copy of telcoin/telcoin-contracts@11d37ae contracts/swap/AmirX.sol.
//
// ONLY functional change vs the deployed implementation: the TELCOIN constant is
// repointed from legacy TEL (0xdF7837DE1F2Fa4631D716CF2502f8b230F1dcc32) to the
// deterministic CREATE3 address at which the fork test setUp deploys TelcoinV3.
// Replace with the real TelcoinV3 Polygon mainnet address once the mainnet
// CREATE3 salts/deployer Safe are finalized.
//
// NOTE: this compiles against tel-v3's OZ submodule (5.6.x), not the OZ 5.0.1
// pinned by telcoin-contracts — behaviorally equivalent for these paths but NOT
// byte-identical. The production upgrade artifact must be compiled from
// telcoin-contracts; re-run this suite against that exact bytecode (vm.etch)
// before the real upgrade.

import {AccessControlUpgradeable, SafeERC20, Stablecoin, StablecoinHandler} from "./StablecoinHandler.sol";
...
contract AmirX is StablecoinHandler {
    ...
    // TelcoinV3 token address (fork-test CREATE3 address; see file header)
    ERC20 public constant TELCOIN = ERC20(0x940C74Faa99beFD6745A7B54346A22076E376E62);
